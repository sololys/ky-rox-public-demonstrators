#!/usr/bin/env python3
"""
public_surface_verifier_v0_2.py

KY-ROX Public Surface Gate v0.2

Purpose:
- Verify that the public demonstrator repository is structurally presentable.
- Detect obvious hygiene failures.
- Detect risky wording outside controlled boundary/disclaimer contexts.
- Avoid self-poisoning by excluding generated reports and verifier source files.
...
REPORT_PATH = REPORT_DIR / "PUBLIC_SURFACE_REPORT_v0_2.md"
...
EXCLUDED_FILE_PREFIXES = [
    "scripts/public_surface_verifier_",
]
...
def main() -> int:
    ...
    report = []
    report.append("# Public Surface Report v0.2")
    report.append("")
    ...
    print(f"PUBLIC_SURFACE_VERIFIER_V0_2: {verdict}")
